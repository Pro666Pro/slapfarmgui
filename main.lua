...
local Window = OrionLib:MakeWindow({IntroText = "slap farm gui! v4.0", IntroIcon = "rbxassetid://15315284749",Name = GameName, HidePremium = false, SaveConfig = true, ConfigFolder = "Tutorial"})
